...
3. **Code Generation**: Uses Llama 3.1 to generate precise Pandas code based on the dataset's structure and sample data.
...
* **`src/`**: Core application logic.
    * `ollama.py`: Manages communication with the local Ollama API.
...
* **Llama 3.1 (via Ollama)**: Local Large Language Model for reasoning and code generation.
...
* **Local & Private**: No data leaves your machine; all analysis is performed locally via Llama 3.1.
